...
namespace CSharpMinds.Hellstorm
{
    class EnemySpawner : Component, IUpdatable
    {
        ...
        public void Update(Common.GameTime gameTime)
        {
            ...
            {
                SceneManager.AddGameObjectToScene(GameObjectFactory.Build("enemy", new List<Interfaces.IComponent>() {
                new TransformComponent(new Common.Vector(700, r.Next(400))),
                new PhysicsComponent(),
                new EnemyLogic(),
                new BoxColliderComponent(85, 95),
                new SpriteRenderComponent("Hellstorm\\Resources\\" + _enemies[r.Next(_enemies.Length)] + ".png")
            }));
            }
